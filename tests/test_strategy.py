...
from psqlextra.partitioning import PostgresPartitioningStrategy, PostgresPartition, PostgresTimePartition, \
    PostgresRangePartition
from psqlextra.partitioning.delete_on_condition_strategy import PostgresDeleteOnConditionPartitioningStrategy
...
def test_delete_on_condition():
    ...
    strategy = PostgresDeleteOnConditionPartitioningStrategy(delegate=TestStrategy(), delete_condition=test_condition)
